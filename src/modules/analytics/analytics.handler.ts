...
export function pageViewHandler(req: Request, res: Response, _next: NextFunction): void {
...
export async function analyticsRecentHandler(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
